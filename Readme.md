...
InternQuest — мобильное приложение (iOS, Android) с веб-админкой, где пользователи находят малопопулярные программы стажировок и обменов, отслеживают дедлайны и предлагают новые программы через форму заявки.
